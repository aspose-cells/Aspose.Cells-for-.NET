...
namespace Aspose.DotNetNuke.Modules.AsposeDynamicFormGeneratorExcel.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Aspose.DotNetNuke.Modules.AsposeDynamicFormGeneratorExcel.Data.SqlDataprovider,AsposeDNNDynamicFormGenerator";
