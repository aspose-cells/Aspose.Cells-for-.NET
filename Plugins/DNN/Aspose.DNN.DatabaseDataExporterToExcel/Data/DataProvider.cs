...
namespace Aspose.DotNetNuke.Modules.AsposeDNNDataExporterExcel.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Aspose.DotNetNuke.Modules.AsposeDNNDataExporterExcel.Data.SqlDataprovider,AsposeDNNDataExporter";
