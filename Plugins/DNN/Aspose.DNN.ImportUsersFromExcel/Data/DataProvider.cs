...
namespace Aspose.DotNetNuke.Modules.Aspose.DNN.ImportUsersFromExcel.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Aspose.DotNetNuke.Modules.Aspose.DNN.ImportUsersFromExcel.Data.SqlDataprovider,Aspose.DNN.ImportUsersFromExcel";
