...
namespace Aspose.DotNetNuke.Modules.Aspose.DNN.ExportUsersAndRolesToExcel.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Aspose.DotNetNuke.Modules.Aspose.DNN.ExportUsersAndRolesToExcel.Data.SqlDataprovider,Aspose.DNN.ExportUsersAndRolesToExcel";
