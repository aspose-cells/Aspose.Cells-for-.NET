...
using AsposeVisualStudioPluginCells.GUI;
using AsposeVisualStudioPluginCells.Properties;
using Microsoft.VisualStudio.CommandBars;

namespace AsposeVisualStudioPluginCells
{
    public class Connect : Extensibility.IDTExtensibility2, IDTCommandTarget
    {
        ...
        private const string Cells_COMMAND_NAME = "AsposeCellsVSPlugin";
        private const string Cells_COMMAND_CAPTION = "New Aspose.Cells Example Project";
        private const string Cells_COMMAND_TOOLTIP = "Download and run Aspose.Cells for .NET API Examples";
           ...
           ref object varOut, ref bool handled)
        {
            try
            {
                ...
                {
                    if (cmdName == addInInstance.ProgID + "." + Cells_COMMAND_NAME)
                    {
