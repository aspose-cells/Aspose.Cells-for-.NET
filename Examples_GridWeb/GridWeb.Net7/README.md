# Examples of Aspose.Cells.GridWeb in .Net7
...
### 5. add session support and GridScheduedService (optional, GridScheduedService will delete temporary files two days ago in the GridWeb.SessionStorePath )
 startup.cs:
