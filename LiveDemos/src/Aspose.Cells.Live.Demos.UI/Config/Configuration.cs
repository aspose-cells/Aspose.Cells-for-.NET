...
namespace Aspose.Cells.Live.Demos.UI.Config
{
	...
	{		
		...
		private static string _asposeCellsLiveDemosPath = ConfigurationManager.AppSettings["AsposeCellsLiveDemosPath"].ToString();
		...
		private static string _productsAsposeCellsAssetURL = ConfigurationManager.AppSettings["ProductsAsposeCellsAssetURL"];
		...
		{
			get { return _productsAsposeCellsAssetURL; }
		}	
        ...
        {
            get { return _asposeCellsLiveDemosPath; }
        }
