...
Namespace Worksheets
    Public Class CopyWorksheets
        ...
        Protected Sub btnCopyWorksheet_Click(sender As Object, e As EventArgs)
            ' ExStart:CopyWorksheetUsingIndex
            ' Adding the copy of a worksheet to GridWeb by specifying its sheet index
            Dim sheetIndex As Integer = GridWeb1.WorkSheets.AddCopy(0)
            ' ExEnd:CopyWorksheetUsingIndex

            ' ExStart:CopyWorksheetUsingName
            ' Adding the copy of a worksheet to GridWeb by specifying its sheet name
            Dim sheetIndex1 As Integer = GridWeb1.WorkSheets.AddCopy("Students")
            ' ExEnd:CopyWorksheetUsingName
        End Sub
    End Class
End Namespace
