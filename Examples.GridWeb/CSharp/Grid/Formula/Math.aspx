<%@ Page Language="C#" AutoEventWireup="true" Inherits="demos_Formula_Math" MasterPageFile="~/tpl/Demo.Master"
    Title="Math - Formula - Aspose.Cells Grid Suite Demos" CodeBehind="Math.aspx.cs" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
            ...
            <tr>
                ...
                <td class="demos-heading-bg" style="width: 100%;">
                    <h2 class="demos-heading-bg">
                        Math - Formula - Aspose.Cells Grid Suite Demos
                    </h2>
                </td>
                <td style="width: 19; vertical-align: top;">
    ...
    <div style="text-align: left; font-family: Arial; font-size: small;" class="componentDescriptionTxt">
        ...
        <p>
            Please download the
            <asp:HyperLink ID="lnkFile" runat="server" NavigateUrl="~/file/Math.xls">Math.xls</asp:HyperLink>
            used in this demo.</p>
        <table>
            <tr>
                <td>
