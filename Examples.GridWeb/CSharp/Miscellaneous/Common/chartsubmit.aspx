<%@ Page Language="C#" AutoEventWireup="true" Inherits="chartsubmit" MasterPageFile="~/tpl/Demo.Master"
    Title="Create Invoice - Aspose.Cells Grid Suite Demos" CodeBehind="chartsubmit.aspx.cs" %>
            ...
            <table class="i1" id="Table1">
                ...
                <tr>
                    <td colspan="2" class="demo">
                        <acw:GridWeb ID="GridWebchart" runat="server" Height="538px" Width="1200px"  AutoRefreshChart=false OnSubmitCommand="submitaction">
                        </acw:GridWeb>
                    </td>
                </tr>
            </table>
