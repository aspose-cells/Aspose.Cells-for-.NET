<%@ Page Language="C#" AutoEventWireup="true" Inherits="demos_Common_modes" MasterPageFile="~/tpl/Demo.Master"
    Title="Edit/ReadOnly Mode - Aspose.Cells Grid Suite Demos" CodeBehind="modes.aspx.cs" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
            ...
            <tr>
                ...
                <td class="demos-heading-bg" style="width: 100%;">
                    <h2 class="demos-heading-bg">
                        Edit/ReadOnly Mode - Aspose.Cells Grid Suite Demos
                    </h2>
                </td>
                <td style="width: 19; vertical-align: top;">
    ...
    <div style="text-align: left; font-family: Arial; font-size: small;" class="componentDescriptionTxt">
        <p class="componentDescriptionTxt">
            Click <b>Enable Editing</b> to see how demo toggles editable / read-only mode, also we can specify to row level and column level.
        </p>
        <br />
