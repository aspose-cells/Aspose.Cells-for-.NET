...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <table border="1">
        <tr>
			...
			<div class="componentDescriptionTxt"><p class="componentDescriptionTxt">
            ...
            <li class="genericList" title="Resize GridWeb">
			<p class="productTitle"><a href="GridWebBasics/ResizeGridWeb.aspx">Resize Header Bar</a></p>
			<p class="componentDescriptionCaption">Description</p>
			<div class="componentDescriptionTxt"><p class="componentDescriptionTxt">
  ...
  <td>
       ...
       <tr style="display:none">
        ...
        <li class="genericList" title="Import DataView">
			<p class="productTitle"><a href="Miscellaneous/common/importdataview.aspx">Import DataView</a></p>
			<p class="componentDescriptionCaption">Description</p>
			<div class="componentDescriptionTxt"><p class="componentDescriptionTxt">
        ...
        <li class="genericList" title="Edit/ReadOnly Mode">
			<p class="productTitle"><a href="Miscellaneous/common/modes.aspx">Edit/ReadOnly Mode</a></p>
			<p class="componentDescriptionCaption">Description</p>
			<div class="componentDescriptionTxt"><p class="componentDescriptionTxt">
        ...
        <li class="genericList" title="Handling Events">
			<p class="productTitle"><a href="Miscellaneous/common/events.aspx">Handling Events</a></p>
			<p class="componentDescriptionCaption">Description</p>
			<div class="componentDescriptionTxt"><p class="componentDescriptionTxt">
				This Demo Demonstrates Event Handling related to GridWeb Control. 
			</p></div>
        </li>
        <li class="genericList" title="Worksheets">
			<p class="productTitle"><a href="Miscellaneous/common/sheets.aspx">Worksheets</a></p>
			<p class="componentDescriptionCaption">Description</p>
			<div class="componentDescriptionTxt"><p class="componentDescriptionTxt">
        ...
        <li class="genericList" title="Hyperlink &amp; CellImage">
			<p class="productTitle"><a href="Miscellaneous/common/hyperlinkdemo.aspx">Hyperlink &amp; CellImage</a></p>
			<p class="componentDescriptionCaption">Description</p>
			<div class="componentDescriptionTxt"><p class="componentDescriptionTxt">
				The Demo presents the functionality of Hyperlink and CellImage Object.
			</p></div>
	    </li>
        <li class="genericList" title="Sort">
			<p class="productTitle"><a href="Miscellaneous/common/sort.aspx">Sort</a></p>
			<p class="componentDescriptionCaption">Description</p>
			<div class="componentDescriptionTxt"><p class="componentDescriptionTxt">
