...
using Aspose.Cells.Parser.Controllers;
...
namespace Aspose.Cells.Parser
{
    public class Startup
    {
        private static readonly AppNames appName = AppNames.Parser;
        ...
        {
            services.AddScoped<ICellsController, ParserController>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                if (Configuration.IsAsposeCloudApp)
                {
                    endpoints.MapControllerRoute("ParserCloudApi", "cells/" + AppName + "/api/ParserApi/{action}",
                        new { controller = "ParserCloudApi", action = AppName });
                }
                else
                {
                    endpoints.MapControllerRoute("ParserApi", "cells/" + AppName + "/api/ParserApi/{action}",
                        new { controller = "ParserApi", action = AppName });
                }
            });
            app.UseEndpoints(endpoints =>
            {
