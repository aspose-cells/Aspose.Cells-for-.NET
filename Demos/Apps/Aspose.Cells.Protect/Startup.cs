...
using Aspose.Cells.Protect.Controllers;
...
namespace Aspose.Cells.Protect
{
    public class Startup
    {
        private static readonly AppNames appName = AppNames.Protect;
        ...
        {
            services.AddScoped<ICellsController, ProtectController>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                if (Configuration.IsAsposeCloudApp)
                {
                    endpoints.MapControllerRoute("ProtectCloudApi", "cells/" + AppName + "/api/ProtectApi/{action}",
                        new { controller = "ProtectCloudApi", action = AppName });
                }
                else
                {
                    endpoints.MapControllerRoute("ProtectApi", "cells/" + AppName + "/api/ProtectApi/{action}",
                        new { controller = "ProtectApi", action = AppName });
                }
            });
            app.UseEndpoints(endpoints =>
            {
