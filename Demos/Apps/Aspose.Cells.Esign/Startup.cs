...
using Aspose.Cells.Esign.Controllers;
...
namespace Aspose.Cells.Esign
{
    ...
    {
        private static readonly AppNames appName = AppNames.Esign;
        ...
        {
            services.AddScoped<ICellsController, EsignController>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                if (Configuration.IsAsposeCloudApp)
                {
                    endpoints.MapControllerRoute("EsignCloudApi", "cells/" + AppName + "/api/EsignApi/{action}",
                        new { controller = "EsignCloudApi", action = AppName });
                }
                else
                {
                    endpoints.MapControllerRoute("EsignApi", "cells/" + AppName + "/api/EsignApi/{action}",
                        new { controller = "EsignApi", action = AppName });
                }
            });
            app.UseEndpoints(endpoints =>
            {
