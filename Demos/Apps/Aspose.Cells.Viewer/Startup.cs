...
using Aspose.Cells.Viewer.Controllers;
...
namespace Aspose.Cells.Viewer
{
    public class Startup
    {
        private static readonly AppNames appName = AppNames.Viewer;
        ...
        {
            services.AddScoped<ICellsController, ViewerController>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(AppName, "cells/" + AppName + "/view",
                    new {controller = AppName, action = "View"});
            });
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute("ViewerApi", "cells/" + AppName + "/api/ViewerApi/{action}",
                    new {controller = "ViewerApi", action = AppName});
            });
            app.UseEndpoints(endpoints =>
            {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute("UploadFile", "cells/" + AppName + "/api/Common/{action}/{id}",
                    new {controller = "ViewerApi", action = "UploadFile", id = ""});
            });
            app.UseEndpoints(endpoints =>
            {
