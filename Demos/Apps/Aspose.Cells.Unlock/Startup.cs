...
using Aspose.Cells.Unlock.Controllers;
...
namespace Aspose.Cells.Unlock
{
    public class Startup
    {
        private static readonly AppNames appName = AppNames.Unlock;
        ...
        {
            services.AddScoped<ICellsController, UnlockController>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                if (Configuration.IsAsposeCloudApp)
                {
                    endpoints.MapControllerRoute("UnlockCloudApi", "cells/" + AppName + "/api/UnlockApi/{action}",
                        new { controller = "UnlockCloudApi", action = AppName });
                }
                else
                {
                    endpoints.MapControllerRoute("UnlockApi", "cells/" + AppName + "/api/UnlockApi/{action}",
                        new { controller = "UnlockApi", action = AppName });
                }
            });
            app.UseEndpoints(endpoints =>
            {
