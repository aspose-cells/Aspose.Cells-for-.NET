...
using Aspose.Cells.Mortgage.Controllers;
...
namespace Aspose.Cells.Mortgage
{
    public class Startup
    {
        internal static string AppName => "mortgage-calculator";
        ...
        {
            services.AddScoped<ICellsController, MortgageController>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            var options = new StaticFileOptions
            {
                ...
                RequestPath = "/cells/" + AppName + "/content"
            };
            ...
            {
                endpoints.MapControllerRoute(AppName, "cells/" + AppName,
                    new { controller = "Mortgage", action = "Mortgage" });
            });
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute("MortgageApi", "cells/" + AppName + "/api/MortgageApi/{action}",
                    new { controller = "MortgageApi" });
            });
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute("Feedback", "cells/" + AppName + "/sendfeedback",
                    new { controller = "Mortgage", action = "SendFeedback" });
            });
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute("Feedback", "cells/" + AppName + "/sendemail",
                    new { controller = "Mortgage", action = "SendEmail" });
            });
            app.UseEndpoints(endpoints =>
            {
