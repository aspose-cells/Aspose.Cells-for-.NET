using System.IO;
using Aspose.Cells.Annotation.Controllers;
...
namespace Aspose.Cells.Annotation
{
    public class Startup
    {
        private static readonly AppNames appName = AppNames.Annotation;
        ...
        {
            services.AddScoped<ICellsController, AnnotationController>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                if (Configuration.IsAsposeCloudApp)
                {
                    endpoints.MapControllerRoute("AnnotationCloudApi", "cells/" + AppName + "/api/AnnotationApi/{action}",
                        new { controller = "AnnotationCloudApi", action = AppName });
                }
                else
                {
                    endpoints.MapControllerRoute("AnnotationApi", "cells/" + AppName + "/api/AnnotationApi/{action}",
                        new { controller = "AnnotationApi", action = AppName });
                }
            });
            app.UseEndpoints(endpoints =>
            {
