using System.IO;
using Aspose.Cells.Assembly.Controllers;
...
namespace Aspose.Cells.Assembly
{
    public class Startup
    {
        private static readonly AppNames appName = AppNames.Assembly;
        ...
        {
            services.AddScoped<ICellsController, AssemblyController>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                if (Configuration.IsAsposeCloudApp)
                {
                    endpoints.MapControllerRoute("AssemblyCloudApi", "cells/" + AppName + "/api/AssemblyApi/{action}",
                        new { controller = "AssemblyCloudApi", action = AppName });
                }
                else
                {
                    endpoints.MapControllerRoute("AssemblyApi", "cells/" + AppName + "/api/AssemblyApi/{action}",
                       new { controller = "AssemblyApi", action = AppName });
                }
            });
            app.UseEndpoints(endpoints =>
            {
