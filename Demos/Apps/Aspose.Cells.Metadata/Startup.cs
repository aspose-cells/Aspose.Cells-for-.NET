...
using Aspose.Cells.Metadata.Controllers;
...
namespace Aspose.Cells.Metadata
{
    ...
    {
        private static readonly AppNames appName = AppNames.Metadata;
        ...
        {
            services.AddScoped<ICellsController, MetadataController>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                if (Configuration.IsAsposeCloudApp)
                {
                    endpoints.MapControllerRoute("MetadataCloudApi", "cells/" + AppName + "/api/MetadataApi/{action}",
                        new { controller = "MetadataCloudApi", action = AppName });
                }
                else
                {
                    endpoints.MapControllerRoute("MetadataApi", "cells/" + AppName + "/api/MetadataApi/{action}",
                        new { controller = "MetadataApi", action = AppName });
                }
            });
            app.UseEndpoints(endpoints =>
            {
