...
using Aspose.Cells.Comparison.Controllers;
...
namespace Aspose.Cells.Comparison
{
    public class Startup
    {
        private static readonly AppNames appName = AppNames.Comparison;
        ...
        {
            services.AddScoped<ICellsController, ComparisonController>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(AppName, "cells/" + AppName + "/compare",
                    new {controller = AppName, action = "Compare"});
            });
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute("ComparisonApi", "cells/" + AppName + "/api/ComparisonApi/{action}",
                    new {controller = "ComparisonApi", action = AppName});
            });
            app.UseEndpoints(endpoints =>
            {
