...
using Aspose.Cells.Splitter.Controllers;
...
namespace Aspose.Cells.Splitter
{
    public class Startup
    {
        private static readonly AppNames appName = AppNames.Splitter;
        ...
        {
            services.AddScoped<ICellsController, SplitterController>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                if (Configuration.IsAsposeCloudApp)
                {
                    endpoints.MapControllerRoute("SplitterCloudApi", "cells/" + AppName + "/api/SplitterApi/{action}",
                        new { controller = "SplitterCloudApi", action = AppName });
                }
                else
                {
                    endpoints.MapControllerRoute("SplitterApi", "cells/" + AppName + "/api/SplitterApi/{action}",
                        new { controller = "SplitterApi", action = AppName });
                }
            });
            app.UseEndpoints(endpoints =>
            {
