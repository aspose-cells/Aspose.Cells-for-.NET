...
using Aspose.Cells.Search.Controllers;
...
namespace Aspose.Cells.Search
{
    public class Startup
    {
        private static readonly AppNames appName = AppNames.Search;
        ...
        {
            services.AddScoped<ICellsController, SearchController>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                if (Configuration.IsAsposeCloudApp)
                {
                    endpoints.MapControllerRoute("SearchCloudApi", "cells/" + AppName + "/api/SearchApi/{action}",
                        new { controller = "SearchCloudApi", action = AppName });
                }
                else
                {
                    endpoints.MapControllerRoute("SearchApi", "cells/" + AppName + "/api/SearchApi/{action}",
                        new { controller = "SearchApi", action = AppName });
                }
            });
            app.UseEndpoints(endpoints =>
            {
