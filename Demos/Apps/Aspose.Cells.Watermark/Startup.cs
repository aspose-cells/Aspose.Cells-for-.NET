...
using Aspose.Cells.Watermark.Controllers;
...
namespace Aspose.Cells.Watermark
{
    public class Startup
    {
        private static readonly AppNames appName = AppNames.Watermark;
        ...
        {
            services.AddScoped<ICellsController, WatermarkController>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                if (Configuration.IsAsposeCloudApp)
                {
                    endpoints.MapControllerRoute("WatermarkCloudApi", "cells/" + AppName + "/api/WatermarkApi/{action}",
                   new { controller = "WatermarkCloudApi", action = AppName });
                }
                else
                {
                    endpoints.MapControllerRoute("WatermarkApi", "cells/" + AppName + "/api/WatermarkApi/{action}",
                   new { controller = "WatermarkApi", action = AppName });
                }
            });
            app.UseEndpoints(endpoints =>
            {
