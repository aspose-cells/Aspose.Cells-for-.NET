...
using Aspose.Cells.Conversion.Controllers;
...
namespace Aspose.Cells.Conversion
{
    public class Startup
    {
        private static readonly AppNames appName = AppNames.Conversion;
        ...
        {
            services.AddScoped<ICellsController, ConversionController>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                if (Configuration.IsAsposeCloudApp)
                {
                    endpoints.MapControllerRoute("ConversionCloudApi", "cells/" + AppName + "/api/ConversionApi/{action}",
                        new { controller = "ConversionCloudApi", action = AppName });
                }
                else
                {
                    endpoints.MapControllerRoute("ConversionApi", "cells/" + AppName + "/api/ConversionApi/{action}",
                        new { controller = "ConversionApi", action = AppName });
                }
            });
            app.UseEndpoints(endpoints =>
            {
