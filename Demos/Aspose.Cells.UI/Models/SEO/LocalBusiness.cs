...
namespace Aspose.Cells.UI.Models.SEO
{
    ...
    {
        [JsonProperty("@type")] public override string Type { get; set; } = "LocalBusiness";

        [JsonProperty("name")] public string Name { get; set; } = "Aspose Pty Ltd";

        [JsonProperty("image")] public string Image { get; set; } //= "https://joomla-asposeapp.dynabic.com/templates/asposeapp/images/product-family/aspose-cells-app.png";

        [JsonProperty("telephone")] public string Telephone { get; set; } = "+19033061676";
        ...
        [JsonProperty("priceRange")] public string PriceRange { get; set; } = "$$";
