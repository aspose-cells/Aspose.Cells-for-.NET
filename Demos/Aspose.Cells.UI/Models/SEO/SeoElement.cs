...
namespace Aspose.Cells.UI.Models.SEO
{
    ...
    {
        [JsonProperty("@context")] public virtual string Context { get; set; } = "https://schema.org";
    ...
    {
        [JsonProperty("@type")] public override string Type { get; set; } = "Thing";

        [JsonProperty("name")] public virtual string Name { get; set; }

        [JsonProperty("alternateName")] public virtual string AlterName { get; set; }

        [JsonProperty("description")] public virtual string Description { get; set; }

        [JsonProperty("image")] public virtual ImageObject Image { get; set; }
    ...
    {
        [JsonProperty("@type")] public override string Type { get; set; } = "CreativeWork";
