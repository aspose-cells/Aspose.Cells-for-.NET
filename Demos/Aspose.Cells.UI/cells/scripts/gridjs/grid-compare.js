...
$(function () {
    ...
    const baseUrl = `${APIBasePath}AsposeCellsComparison/DetailJson`;
    const finalUrl = `${baseUrl}?file1=${encodeURIComponent(file1)}&file2=${encodeURIComponent(file2)}&folderName=${encodeURIComponent(folderName)}`;
    $.ajax({
    ...
    function successFunction(data) {
        ...
        const jsonData1 = JSON.parse(parseData.File1Json);
        const jsonData2 = JSON.parse(parseData.File2Json);
...
function load(jsonData1, jsonData2) {
    ...
    const imageUrl = APIBasePath + "AsposeCellsComparison/Image";
