(function () {
    ...
    function main($scope, $http, Upload, $templateRequest, $sce, $compile) {
        ...
        var helpDataSource = $sce.getTrustedResourceUrl('/cells/assembly/cellsHelpDataSource.html');
        ...
        var helpTemplate = $sce.getTrustedResourceUrl('/cells/assembly/cellsHelpTemplate.html');
