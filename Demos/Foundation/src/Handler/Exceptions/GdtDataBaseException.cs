...
{
    public class GdtDataBaseException : DocumentsToolsException
    {
        public GdtDataBaseException(string locale, IExceptionHandler exceptionHandler)
        ...
        private static string GetMessage(string locale, IExceptionHandler exceptionHandler)
        {
            ...
            return exceptionHandler.getException(locale, "db");
        }
    }
}