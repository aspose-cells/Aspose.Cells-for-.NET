...
{
    public class GdtNullReferenceException : DocumentsToolsException
    {
        public GdtNullReferenceException(string locale, IExceptionHandler exceptionHandler)
        ...
        private static string GetMessage(string locale, IExceptionHandler exceptionHandler)
        {
            ...
            return exceptionHandler.getException(locale, "NullReferenceException");
        }
    }
}